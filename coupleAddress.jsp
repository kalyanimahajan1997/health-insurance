        ...
        <body> 
          ...
          if (request.getParameter("submit") != null) {%>
                    ...
                    <form action="policyHolderController?op=addCouple" class="form" method="post" enctype="multipart/form-data">
                          My image: <br><img src="${policyHolder1.image}" style="width:200px;height: 200px" border="2" id="preview" onchange="readURL(this, preview);"  class="form"/><br/>
                        <input type="file" class="btn btn-success form-control" name="image1"/><br>
                      
                        MY Wife's image: <br><img src="${policyHolder2.image}" style="width:200px;height: 200px" border="2" id="preview" onchange="readURL(this, preview);" class="form"/><br/>     
                        <input type="file" class="btn btn-success form-control" name="image2"/>
                             ...
                             <a href="couple.jsp" class="btn btn-danger">Reset</a>
                        </form>
                    <%}
                    %>
           </div>
