    ...
    <head>
        ...
        <body> 
          ...
          if (request.getParameter("submit") != null) {%>
                    ...
                    <form action="policyHolderController?op=addFamily1" class="form" method="post" enctype="multipart/form-data">
                        ...
                        My Kid's image:  <img src="${policyHolder3.image}" style="width:100px;height: 100px" border="2" id="preview" onchange="readURL(this, preview);" class="form"/>     
                        <input type="file" class="btn btn-success form-control" name="image3"/>
                                             
                       
                                            <input type="submit" name="submit" value="confirm" class="btn btn-primary " >                        
                             <a href="family1Form.jsp" class="btn btn-danger">Reset</a>
                        </form>
                    <%}
                    %>
           </div>
        ...
        <%
            ...
            if (request.getParameter("submit3") != null) {
                 ...
                 if(gender.equalsIgnoreCase("male")) session.setAttribute("rel3", "son");
                  ...
                  System.out.println("===2" + request.getParameter("submit3"));%>
