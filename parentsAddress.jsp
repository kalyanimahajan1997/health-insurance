    ...
    <head>
        ...
        <body> 
          ...
          if (request.getParameter("submit") != null) {%>
                    ...
                    <form action="policyHolderController?op=addCouple" class="form" method="post" enctype="multipart/form-data">
                          Father's image: <br><img src="${policyHolder1.image}" style="width:200px;height: 200px" border="2" id="preview" onchange="readURL(this, preview);"  class="form"/><br/>
                        <input type="file" class="btn btn-success form-control" name="image1"/><br>
                      
                        Mother's image: <br><img src="${policyHolder2.image}" style="width:200px;height: 200px" border="2" id="preview" onchange="readURL(this, preview);" class="form"/><br/>     
                        <input type="file" class="btn btn-success form-control" name="image2"/>
                             ...
                             <a href="parentsForm.jsp" class="btn btn-danger">Reset</a>
                        </form>
                    <%}
                    %>
           </div>
        ...
        <%
            ...
            if (request.getParameter("submit2") != null) {
                session.setAttribute("rel2", "mother");
                  System.out.println("===2" + request.getParameter("submit2"));%>
        ...
        <%}
            PolicyHolder ph = (PolicyHolder) session.getAttribute("policyHolder2");
            System.out.println("name2:" + ph.getName());%>
