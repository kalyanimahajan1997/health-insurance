...
<html lang="en">
    <head>
        ...
        <jsp:useBean class="beans.PolicyHolder" id="policyHolder3" scope="session"></jsp:useBean>     
        <jsp:useBean class="beans.PolicyHolder" id="policyHolder4" scope="session"></jsp:useBean>     
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" id="div4"  >
                        <% if (request.getParameter("submit2") != null) {
                              session.setAttribute("rel2", "wife");
                                System.out.println("===" + request.getParameter("submit2"));%>
                        <jsp:setProperty name="policyHolder2" property="*"></jsp:setProperty>
                            <br><h4><b>My 1st Kids's Info</b></h4>
                            <form class="form"> 
                                <br>Enter Your Name : <input type="text" name="name" value="${policyHolder3.name}" class="form-control">
                            <br>Enter Father's Name : <input type="text" name="fname" value="${policyHolder1.name}" class="form-control">
                            <br>Enter Your Email : <input type="email" name="email" value="${policyHolder3.email}" class="form-control">
                            <br>Enter Your Contact : <input type="text" maxlength="10" name="contact" value="${policyHolder3.contact}" class="form-control">
                            <br>Enter Your Dob : <input type="date" name="dob" value="${policyHolder3.dob}" class="form-control">
                            <br>Select Your Gender : <input type="radio" name="gender" value="male"  ${policyHolder3.gender eq "male" ? "checked":""}>Male
                            <input type="radio" name="gender" value="female" ${policyHolder3.gender eq "female" ? "checked":""}>Female<br>

                            <br>Select Your Occupation : <select name="occupation" class="form-control">
                                <option>select</option> <option>salaried</option> <option>self employed</option>
                                <option>student</option> <option>retired</option> <option>house wife</option>
                            </select>
                            <br> <input type="submit" name="submit3" class="btn btn-warning" value="Next">                        
                 ...
                 if(gender.equalsIgnoreCase("male")) session.setAttribute("rel3", "son");
                 else session.setAttribute("rel3", "daughter");
                                System.out.println("===" + request.getParameter("submit3"));%>
                        <jsp:setProperty name="policyHolder3" property="*"></jsp:setProperty>
                            <br><h4><b>My 2nd Kids's Info</b></h4>
                            <form class="form" action="family2Address.jsp"> 
                                <br>Enter Your Name : <input type="text" name="name" value="${policyHolder3.name}" class="form-control">
                            <br>Enter Father's Name : <input type="text" name="fname" value="${policyHolder1.name}" class="form-control">
                            <br>Enter Your Email : <input type="email" name="email" value="${policyHolder3.email}" class="form-control">
                            <br>Enter Your Contact : <input type="text" maxlength="10" name="contact" value="${policyHolder3.contact}" class="form-control">
                            ...
                            <br> <input type="submit" name="submit4" class="btn btn-warning" value="Next">                        
