    ...
    <head>
        ...
        <body> 
            <div class="container">
             ...
             <div class="col col-md-9" style="position: fixed;right: 0px;">
                             <%
          if (request.getParameter("submit") != null) {%>
                    <jsp:setProperty name="policyHolderAddress" property="*"></jsp:setProperty>
                    <form action="policyHolderController?op=addFamily2" class="form" method="post" enctype="multipart/form-data">
                          My image:<img src="${policyHolder1.image}" style="width:100px;height: 100px" border="2" id="preview" onchange="readURL(this, preview);"  class="form"/> 
                        <input type="file" class="btn btn-success form-control" name="image1"/>
                      
                        My wife's image:  <img src="${policyHolder2.image}" style="width:100px;height: 100px" border="2" id="preview" onchange="readURL(this, preview);" class="form"/>      
                        <input type="file" class="btn btn-success form-control" name="image2"/>
                                             
                                            
                        My 1st Kid's image:  <img src="${policyHolder3.image}" style="width:100px;height: 100px" border="2" id="preview" onchange="readURL(this, preview);" class="form"/>     
                        <input type="file" class="btn btn-success form-control" name="image3"/>
                                             
                        My 2nd Kid's image:  <img src="${policyHolder4.image}" style="width:100px;height: 100px" border="2" id="preview" onchange="readURL(this, preview);" class="form"/>     
                        <input type="file" class="btn btn-success form-control" name="image3"/>
                       
                        
                                            <input type="submit" name="submit" value="confirm" class="btn btn-primary " >                        
                             <a href=" family2Form.jsp" class="btn btn-danger">Reset</a>
                        </form>
                    <%}
                    %>
           </div>
        ...
        <%
            ...
            if (request.getParameter("submit4") != null) {
                 ...
                 if(gender.equalsIgnoreCase("male")) session.setAttribute("rel4", "son");
                 else session.setAttribute("rel4", "daughter");
                  System.out.println("===2" + request.getParameter("submit4"));%>
        
        <jsp:setProperty name="policyHolder4" property="*"></jsp:setProperty> 
        ...
        <%}
            PolicyHolder ph = (PolicyHolder) session.getAttribute("policyHolder3");
            System.out.println("name3:" + ph.getName());%>
